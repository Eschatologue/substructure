 /*
    ...
    See https://github.com/Anuken/Mindustry/blob/master/tools/src/mindustry/tools/Image.java
*/
...
class Image{
    ...
    void drawCenter(Image region){
        draw(region, (width - region.width) / 2, (height - region.height) / 2, false, false);
    }

    /** Draws a region at the center. */
    void drawCenter(Image region, boolean flipx, boolean flipy){
